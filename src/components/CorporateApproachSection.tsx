            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="py-8 flex flex-col justify-center px-6 lg:px-12">
                        ...
                        <div className="inline-block bg-[#F2F1DF] px-4 py-1.5 rounded-full mb-8">
                        ...
                        <div className="prose prose-lg text-gray-600 font-light leading-relaxed space-y-8">
                            <p className="text-xl text-[#262626] font-medium leading-normal">
                                Flowera est un partenaire stratégique qui transforme vos ambitions en leviers de performance.
                            </p>
                            <p>
                    ...
                    <div className="relative mt-12 lg:mt-0">
                        ...
                        <div className="hidden lg:block absolute left-0 top-0 bottom-0 w-[4px] bg-[#027333] shadow-[0_0_15px_rgba(255,182,0,0.6)] z-20"></div>

                        {/* Conteneur Fond Crème */}
                        <div className="bg-[#F2F1DF] p-10 lg:p-16 h-full flex flex-col justify-center relative shadow-2xl">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#027333]/5 blur-[80px] rounded-full pointer-events-none"></div>

                            <h3 className="text-3xl font-bold text-[#262626] mb-12 font-display">
                            ...
                            <ul className="space-y-10">
                                ...
                                <li className="flex items-start gap-6 group">
                                    <div className="w-12 h-12 rounded-xl bg-[#027333]/10 flex items-center justify-center shrink-0 border border-[#027333]/20 group-hover:border-[#027333] transition-colors">
                                        <TrendingUp className="text-[#027333] w-6 h-6" />
                                    </div>
                                    <div>
                                        <strong className="text-[#262626] text-lg block mb-1">Restaurer vos Marges</strong>
                                        <span className="text-[#262626]/60 font-light leading-relaxed block">
                                ...
                                <li className="flex items-start gap-6 group">
                                    <div className="w-12 h-12 rounded-xl bg-[#027333]/10 flex items-center justify-center shrink-0 border border-[#027333]/20 group-hover:border-[#027333] transition-colors">
                                        <ShieldCheck className="text-[#027333] w-6 h-6" />
                                    </div>
                                    <div>
                                        <strong className="text-[#262626] text-lg block mb-1">Fiabilité & Auditabilité</strong>
                                        <span className="text-[#262626]/60 font-light leading-relaxed block">
                                ...
                                <li className="flex items-start gap-6 group">
                                    <div className="w-12 h-12 rounded-xl bg-[#027333]/10 flex items-center justify-center shrink-0 border border-[#027333]/20 group-hover:border-[#027333] transition-colors">
                                        <Trophy className="text-[#027333] w-6 h-6" />
                                    </div>
                                    <div>
                                        <strong className="text-[#262626] text-lg block mb-1">Agilité & Vitesse</strong>
                                        <span className="text-[#262626]/60 font-light leading-relaxed block">
