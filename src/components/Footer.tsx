        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start mb-12">
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-5 h-5 bg-[#027333] rounded-sm transform rotate-45 flex items-center justify-center">
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-3">
                <Phone size={16} className="text-[#027333]" />
                <span>+33 7 67 28 82 07</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={16} className="text-[#027333]" />
                <a href="mailto:contact@flowera.fr" className="hover:text-white transition-colors">
                  contact@flowera.fr
                </a>
              </li>
            </ul>
            ...
            <div className="flex gap-4 pt-2">
              <a href="#" className="text-gray-500 hover:text-[#027333] transition-colors" title="LinkedIn"><Linkedin size={18} /></a>
              <a href="#" className="text-gray-500 hover:text-[#027333] transition-colors" title="X (Twitter)"><Twitter size={18} /></a>
              <a href="#" className="text-gray-500 hover:text-[#027333] transition-colors" title="Instagram"><Instagram size={18} /></a>
              <a href="#" className="text-gray-500 hover:text-[#027333] transition-colors" title="TikTok">
          ...
          <div className="lg:col-span-6 bg-[#2A2A2A] rounded-2xl p-6 shadow-xl border border-white/5">
            ...
            <form className="space-y-3">
              ...
              ></textarea>
              <button className="w-full bg-white text-[#262626] px-4 py-2.5 text-sm font-bold hover:bg-[#027333] transition-all flex items-center justify-center rounded-md">
                Envoyer
