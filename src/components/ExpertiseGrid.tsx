...
const ExpertiseGrid: React.FC = () => {
  ...
  const expertises: ExpertiseItem[] = [
    {
      ...
      icon: <Layout className="w-8 h-8 text-[#027333]" />,
    ...
    },
    {
      ...
      icon: <Cpu className="w-8 h-8 text-[#027333]" />,
    ...
    },
    {
      ...
      icon: <Bot className="w-8 h-8 text-[#027333]" />,
    ...
    },
    {
      ...
      icon: <Users className="w-8 h-8 text-[#027333]" />,
    ...
    },
    {
      ...
      icon: <Database className="w-8 h-8 text-[#027333]" />,
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {expertises.map((item, index) => (
          <div
            ...
            className="group p-10 bg-white/90 backdrop-blur-sm border border-gray-200/50 hover:border-[#027333]/30 hover:bg-white hover:shadow-xl transition-all duration-500 cursor-pointer relative overflow-hidden"
          >
            <div className="relative z-10">
              <div className="mb-6 transform group-hover:scale-110 transition-transform duration-500 origin-left">
                {item.icon}
              </div>
              <h3 className="text-2xl font-bold text-[#262626] mb-4 group-hover:text-[#027333] transition-colors">
                {item.title}
              </h3>
            ...
            <span className="absolute bottom-[-20px] right-[-10px] text-[120px] font-bold text-[#262626]/[0.03] select-none">
              0{index + 1}
            </span>
          </div>
        ))}
      ...
      >
        <div className="absolute inset-0 bg-[#262626]/40 backdrop-blur-sm" onClick={() => setActiveDrawer(null)}></div>
          ...
          {activeDrawer && (
            <div className="h-full flex flex-col p-8 lg:p-12 overflow-y-auto">
              <button
                ...
                className="self-end p-2 text-gray-400 hover:text-[#262626] transition-colors mb-4"
              >
                <X size={32} />
              </button>

              <div className="flex-grow">
                <span className="text-[#027333] font-bold text-sm tracking-[0.2em] uppercase mb-4 block">
                  {activeDrawer.drawerTitle || 'Solution Propriétaire'}
                </span>
                <h2 className="text-4xl font-light text-[#262626] mb-6 leading-tight">{activeDrawer.title}</h2>

                {/* ACTION PRIMAIRE REMONTÉE */}
                <div className="mb-8 flex flex-col gap-3">
                  <Link
                    to="/contact"
                    className="w-full bg-[#262626] text-white py-4 font-bold hover:bg-[#027333] hover:text-[#262626] transition-all flex items-center justify-center"
                  >
                    Consulter un expert
                  ...
                  <Link
                    ...
                    className="w-full border border-[#262626] text-[#262626] py-4 font-bold hover:bg-gray-50 transition-all flex items-center justify-center"
                  >
                ...
                <div className="space-y-6 mb-12">
                  ...
                  <div className="bg-[#F2F1DF] p-6 rounded-lg">
                    <h4 className="font-bold mb-3 flex items-center"><ShieldCheck className="w-5 h-5 mr-2 text-[#027333]" /> Sécurité & Conformité</h4>
