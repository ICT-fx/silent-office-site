        ...
        <div className="pt-20 min-h-screen bg-white font-sans text-[#262626]">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex justify-center">
                        <button
                            ...
                            className="bg-white text-[#262626] px-10 py-5 font-bold text-lg hover:bg-[#027333] transition-colors duration-300 flex items-center rounded-sm shadow-xl"
                        >
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
                    <div className="md:w-1/2">
                        ...
                        <h2 className="text-3xl md:text-5xl font-light text-[#262626] mb-8 leading-tight">
                            Accélérer dans le cadre du plan <span className="font-bold text-blue-900">Osez l'IA</span>
                        </h2>
                        <div className="w-20 h-1 bg-[#027333] mb-8"></div>
                    ...
                    <div className="md:w-1/2 relative">
                        ...
                        <div className="relative aspect-video bg-gradient-to-br from-blue-900 to-indigo-900 rounded-2xl shadow-2xl p-8 flex items-center justify-center text-white overflow-hidden">
                            ...
                            <div className="text-center z-10">
                                <Activity size={64} className="mx-auto mb-4 text-[#027333]" />
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-20">
                        ...
                        <h2 className="text-4xl font-light text-[#262626]">Une approche holistique : <span className="font-bold">De l'Humain à la Technique</span></h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        ...
                        <div className="group p-8 border border-gray-100 bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-xl relative overflow-hidden">
                            <div className="absolute top-0 left-0 w-2 h-full bg-[#027333]"></div>
                            <div className="mb-8 p-4 bg-green-50 rounded-full w-20 h-20 flex items-center justify-center text-[#027333]">
                                <Users size={32} />
                            </div>
                            <h3 className="text-2xl font-bold mb-4 text-[#262626]">Immersion Métier</h3>
                        ...
                        <div className="group p-8 border border-gray-100 bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-xl relative overflow-hidden">
                            <div className="absolute top-0 left-0 w-2 h-full bg-[#262626]"></div>
                            <div className="mb-8 p-4 bg-gray-100 rounded-full w-20 h-20 flex items-center justify-center text-[#262626]">
                                <Server size={32} />
                            </div>
                            <h3 className="text-2xl font-bold mb-4 text-[#262626]">Audit Technique</h3>
                        ...
                        <div className="group p-8 border border-gray-100 bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-xl relative overflow-hidden">
                            ...
                            <h3 className="text-2xl font-bold mb-4 text-[#262626]">Roadmap & ROI</h3>
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {/* Livrable 1 */}
                        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col items-center text-center hover:border-[#027333] transition-colors">
            ...
            <section className="py-24 px-6 bg-[#262626] text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <button
                        onClick={scrollToContact}
                        className="bg-[#027333] text-[#262626] px-12 py-6 font-bold text-xl hover:bg-white transition-all inline-flex items-center rounded-sm"
                    >
                        Réserver un diagnostic flash
