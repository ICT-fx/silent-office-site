    ...
    if (!data) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-6">
                ...
                <Link to="/" className="text-[#027333] hover:underline">Retour à l'accueil</Link>
            </div>
        );
    }
        ...
        <div className="pt-20 min-h-screen bg-white font-sans text-[#262626]">
            ...
            <section className="relative py-24 px-6 bg-[#262626] text-white overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <button className="bg-[#027333] text-[#262626] px-8 py-4 font-bold text-lg hover:bg-white transition-all flex items-center">
                        Demander un audit
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        <span className="text-[#027333] font-bold uppercase tracking-widest text-sm mb-4 block">Le Diagnostic</span>
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <span className="text-[#027333] font-bold uppercase tracking-widest text-sm mb-4 block">Notre Réponse</span>
                        <h2 className="text-3xl md:text-5xl font-light mb-8 text-[#262626]">{data.solution.title}</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {data.useCases.map((uc, idx) => (
                            <div key={idx} className="p-8 border border-gray-100 rounded-xl hover:shadow-xl hover:border-[#027333]/30 transition-all group">
                                <div className="w-12 h-12 bg-[#F2F1DF] rounded-lg flex items-center justify-center mb-6 group-hover:bg-[#027333] transition-colors">
                                    <uc.icon className="w-6 h-6 text-[#262626]" />
                                </div>
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 text-center md:text-left">
                    ...
                    {data.kpi.map((k, idx) => (
                        <div key={idx} className="border-l border-white/20 pl-8">
                            <div className="text-5xl font-bold text-[#027333] mb-2">{k.value}</div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="relative border-l-2 border-gray-200 ml-6 space-y-12">
                        <div className="relative pl-12">
                            <span className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-[#027333] border-4 border-white"></span>
                        ...
                        <div className="relative pl-12">
                            <span className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-[#262626] border-4 border-white"></span>
            ...
            {/* CTA FINAL */}
            <section className="py-24 px-6 bg-white">
                <div className="max-w-5xl mx-auto text-center bg-[#F2F1DF] rounded-3xl p-12 md:p-20">
                    ...
                    <button className="bg-[#262626] text-white px-10 py-5 font-bold text-lg hover:bg-[#027333] hover:text-[#262626] transition-all inline-flex items-center">
