    ...
    return (
        <div className="pt-20 min-h-screen bg-white font-sans text-[#262626]">
            ...
            <section className="relative py-20 px-6 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
                    <div className="md:w-1/2 z-10">
                        ...
                        <h1 className="text-5xl md:text-6xl font-bold mb-6 text-[#262626] leading-tight">
                            Optimisation & Automatisation des <span className="text-[#027333]">Flux Métier</span>
                        </h1>
                        ...
                        <button
                            ...
                            className="bg-[#262626] text-white px-8 py-4 font-bold text-lg hover:bg-[#027333] hover:text-[#262626] transition-all flex items-center rounded-sm"
                        >
                    ...
                    <div className="md:w-1/2 relative">
                        ...
                        <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl bg-gray-900">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-[#262626] via-transparent to-transparent opacity-60"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
                    <div className="md:w-1/2">
                        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-[#262626]">
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#262626]">Secteurs d'Application</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={idx} className="p-8 border border-gray-100 rounded-lg hover:shadow-lg hover:border-[#027333] transition-all group bg-white">
                                <sector.icon className="w-10 h-10 mb-6 text-gray-400 group-hover:text-[#027333] transition-colors" />
                                <h3 className="font-bold text-lg text-[#262626] mb-2 uppercase text-sm tracking-wide">{sector.title}</h3>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-[#262626]">Notre Méthodologie</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
                        {[
                            ...
                            <div key={idx} className="flex flex-col items-start bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                <span className="text-[#027333] font-bold text-4xl mb-4">{step.nb}</span>
                                <h3 className="text-xl font-bold mb-3 text-[#262626]">{step.title}</h3>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl hover:bg-white/10 transition-colors">
                            <Code2 size={48} className="text-[#027333] mb-6" />
                        ...
                        {/* Carte 2 */}
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl hover:bg-white/10 transition-colors">
                            <Database size={48} className="text-[#027333] mb-6" />
                        ...
                        {/* Carte 3 */}
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl hover:bg-white/10 transition-colors">
                            <Smartphone size={48} className="text-[#027333] mb-6" />
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-[#262626] leading-tight max-w-3xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {[
                            ...
                            <div key={idx} className="flex items-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                                ...
                                <h4 className="font-bold text-lg text-[#262626]">{item.title}</h4>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-5xl font-bold mb-8 text-[#262626]">Prêt à optimiser vos opérations ?</h2>
